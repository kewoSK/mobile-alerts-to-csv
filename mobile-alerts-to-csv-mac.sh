...
#  Intro
# -------
# (dumb) macos shell script which consumes data from sensors presented
...
#  Requirements
# --------------
#  macos version, requires bash, curl, grep and sed 
#
#
#  Initial setup
# ---------------
...
#
#  4.) modify mobile-alerts-to-csv-mac.sh (this) script by editing variables 
